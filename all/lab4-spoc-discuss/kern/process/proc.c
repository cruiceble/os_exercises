...
proc_init(void) {
    ...
    cprintf("boot stack: %d\n",(uintptr_t)bootstack );
    cprintf("boot stack top: %d\n",(uintptr_t)bootstacktop );
    ...
    int mypid = kernel_thread(init_main, "init main3: Hello! I am MtMoon! I have been created!", 0);
